...
import { PageButton, StyledPageButton } from "./PageButton";
        ...
        <div className="mt-6">
            {totalDataLength && (
                <div className="pagination">
                    <PageButton handleClick={() => goToFront(1)} disabled={currentIndex === 1} symbol={"<"} />
                    <PageButton handleClick={() => goToPrev(newNumber)} disabled={currentIndex === 1} symbol={"<"} />
                    {indexArray.map((idx) => {
                        return (
                            <PageButton
                                disabled={false}
